...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = UIColor.colorWith(red: 155, green: 0, blue: 0)
        
        UINavigationBar.appearance().backgroundColor = customGray
        ...
        statusBarBackgroundView.backgroundColor = customGray
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        SongManager.sharedManager.player.stop()
